...
public:
    ...
    FutureProgress *doAddTask(const QFuture<void> &future, const QString &title, int type,
                            ProgressFlags flags);
...
private:
    ...
    void removeOldTasks(int type, bool keepOne = false);
    ...
    QMap<QFutureWatcher<void> *, int> m_runningTasks;
